    ...
    <div class="invoice-wrapper">
        ...
        {{-- <div class="invoice-details">
            <div class="invoice-details-flex">
                <div class="invoice-single-details">
                    <h4 class="invoice-details-title">{{ __('Profile:') }}</h4>
                    <ul class="details-list">
                        <li class="list"> {{ $data->name }} </li>
                        <li class="list"> <a href="#">{{ $data->email }} </a> </li>
                        <li class="list"> <a href="#"> {{ $data->phone }}</a> </li>
                    </ul>
                </div>
                <br><br><br><br><br>
                <div class="invoice-single-details" style="float:right;margin-top:-120px;">
                    <h4 class="invoice-details-title">{{ __('Information:') }}</h4>
                    <ul class="details-list">
                        <li class="list"> {{ $data->address }} </li>
                        <li class="list"> {{ $data->nid }} </li>
                    </ul>
                </div>
            </div>
        </div> --}}
        <div class="item-description">
            <div class="table-responsive">
                <h5 class="table-title">{{ __('All Traine Inform') }}</h5>
                <table class="custom--table">
                    ...
                    <tbody>
                        @foreach ($data as $key=>$tarain)
                            <tr>
                                <td>{{ $key+1 }}</td>
                                <td>{{ $tarain->name }}</td>
                                <td>{{ $tarain->email }}</td>
                                <td>{{ $tarain->phone }}</td>
                                <td>{{ $tarain->designation }}</td>
                            </tr>
                        @endforeach
                        <tr>
                        </tr>
        ...
        <footer>
            <h3 style="text-align: center">
                Thanks For The {{ __('Powerd By Author') }}
            </h3>
        </footer>
